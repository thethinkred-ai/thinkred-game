...
export const Layout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/enterprise-map', label: 'Карта предприятий', icon: '🗺️' },
  ...
  return (
    <div className="layout">
        ...
        <div className="header-content">
          <div className="header-top">
            ...
            <button
              ...
              className="md:hidden btn btn-secondary py-2 px-3 text-sm"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-b border-slate-800/70 bg-slate-950/95 backdrop-blur-sm">
        ...
        <aside className="sidebar">
          ...
          <div className="bg-gradient-to-b from-slate-950/50 to-slate-900/20 border border-slate-800/60 rounded-xl p-4 shadow-inner">
            ...
            <div className="text-sm font-bold text-red-400 flex items-center space-x-2">
              ...
              <span>
                {gameState.currentPeriod === 'feudalism' && 'Феодализм'}
                ...
                {gameState.currentPeriod === 'communism' && 'Коммунизм'}
              </span>
            </div>
          </div>
